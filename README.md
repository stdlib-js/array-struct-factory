...
```javascript
import structFactory from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-struct-factory@v0.1.1-esm/index.mjs';
```
...
import factory from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-struct-factory@v0.1.1-esm/index.mjs';
